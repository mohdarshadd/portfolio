...
export function TerminalSection({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto mb-10 bg-bg-primary/90 backdrop-blur-sm border border-border rounded-lg shadow-[0_10px_30px_rgba(0,0,0,0.4)] overflow-hidden">
